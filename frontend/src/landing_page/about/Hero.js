...
function Hero() {
    return ( 
       <div className='container'>
        <div className ='row p-5 mb-5 text-muted' style={{frontSize:"10px"}}>
            <h1 className='mt-5  text-center'>We pioneered the discount broking model in India.</h1>
            <h1 className='text-center'>Now, we are breaking ground with our technology.</h1>
        </div>
        <div className='row border-top text-muted fs-6' style={{lineHeight:"2"}}>

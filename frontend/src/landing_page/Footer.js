...
function Footer() {
    ...
    return (
        ...
        <div className='row mt-5'>
           ...
           <p className='mt-2'>© 2010 - 2024, Not Zerodha Broking Ltd. All rights reserved.</p>
        </div>
        <div className='col ' >
            <p>company</p>
                    <div className=' '>
        ...
        <div className='row'>
            <div className ='mt-2  text-muted'  style={{fontSize:"15px"}}>
        ...
        <div className ='row '>
            <div className='col '>
                <a href=" "className='mx-4'>Open an account</a>
                <a href=" " className='mx-4'>Open an account</a>
                <a href=" "className='mx-4'>Open an account</a>
                <a href=" "className='mx-4'>Open an account</a>
                <a href=" "className='mx-4'>Open an account</a>
